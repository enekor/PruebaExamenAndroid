...
import com.example.pruebaexamenandroid.BuildConfig;
...
public class SacarFotoAction {
    ...
    private final NuevaReceta main;
    ...
    public SacarFotoAction(Context contexto, Activity activity, NuevaReceta nuevaReceta){
        this.contexto = contexto;
        this.activity = activity;
        this.main = nuevaReceta;
        setLauncher();
    }
